      ...
      <form className='m-auto my-16 max-w-[500px] bg-white p-8 border-2 shadow-md rounded-md'>
        {loading ? (
          ...
          <>
            ...
            <button className='bg-primary text-white px-4 py-2 font-medium hover:bg-primary-dark' style={{ width: "100%" }} onClick={handleSubmit}>Submit</button>

            <div className='pt-4'>
              <Link to="/signup" className='text-blue-400 text-center' style={{ width: "100%", display: "block" }}>Don't have an account? Signup here</Link>
            </div>

            <div className='pt-4'>
            <button className='bg-blue-500 text-white px-4 py-2 font-medium hover:bg-primary-dark' style={{ width: "50%", display: "block", margin: "auto" }} onClick={handleSubmit}>Login with Google</button>
            </div>
          </>
        )}
      </form>
